...
// Define as opções de CORS, permitindo requisições originárias de http://localhost:8000 para se conectar ao front-end
const corsOptions = {
...
const routes = (app) => {
  ...
  // Aplica o middleware CORS à aplicação Express
